README
mon2017dev, оформлення дисертації згідно з вимогами МОН, 2021/07/21 v0.09
...
Вилучено:
-- Підтримку двох списків літератури з класу mon2017dev-aref,
   щоб узгодити з новою версією базового класу vakaref (v0.09),
   у якій додано цю можливість.
...
Потрібні файли:
  ...
  mon2017dev-aref.pdf   приклад файла автореферату дисертації
                          (попередньо згенерований PDF-файл)
Можна звантажити всі вказані файли одним архівом:
  mon2017dev-0.09.zip
...
Copyright 2018–2021 Олександр М. Барановський (Oleksandr M. Baranovskyi)
...
Тому користувачі мають знати про можливі труднощі.
 ...
 7. Сподіваюся, класи сумісні
    ...
    тільки з BibTeX-стилем Springer MathPhys Style
    (виявилося, що класи з ним сумісні).
